...
//		// TODO Is there a cleaner way to do this?
        ...
        while (context instanceof ContextWrapper) {
            ...
            if (base.equals(context))
                break; // Since I'm paranoid, make sure we don't get into an infinite loop.
            context = base;
            if (context instanceof MainActivity)
                break; // Don't go too far because Activity is a ContextWrapper
        }
        if (context instanceof MainActivity) {

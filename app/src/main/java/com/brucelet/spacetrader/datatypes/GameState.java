...
//			opponentFlashAnimator.setInterpolator(AnimationUtils.loadInterpolator(mGameManager, android.R.interpolator.accelerate_decelerate));
    ...
    public void loadState(SharedPreferences prefs) {
        ...
        if (prefs.contains("endStatus"))
            endStatus = EndStatus.values()[prefs.getInt("endStatus", 0)];
...
//		return rng.nextInt() % maxVal;
    ...
    public void showBank() {
        ...
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.BANK)
            return;
...
//		screen.setViewTextById(R.id.screen_bank_credits, R.string.format_cash, 389304);
    ...
    private void drawItem(Purchasable item) {
        ...
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.BUYEQ)
            return;
...
//		screen.setViewTextById(R.id.screen_buyeq_credits, R.string.format_cash, 378511);
    ...
    public void drawBuyShipForm() {
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.BUYSHIP)
            return;
...
//		screen.setViewTextById(R.id.screen_yard_buyship_credits, R.string.format_cash, 378511);
    ...
    public void drawBuyCargoForm() {
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.BUY)
            return;
...
//		screen.setViewTextById(R.id.screen_buy_credits, R.string.format_cash, 197761);
    ...
    public void drawSellCargoForm() {
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.SELL)
            return;
...
//		screen.setViewTextById(R.id.screen_sell_credits, R.string.format_cash, 197761);
    ...
    public void drawSellEquipment() {
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.SELLEQ)
            return;
    ...
    public void showCommanderStatus() {
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.STATUS)
            return;
...
//		screen.setViewTextById(R.id.screen_status_worth, R.string.format_credits, 433195);
    ...
    public void encounterButtons() {
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.ENCOUNTER)
            return;
...
//			amount = min( amount, opponent.type.cargoBays );
        ...
        private boolean executeAction(boolean commanderFlees) {
            ...
            if (encounterType == Encounter.Pirate.ATTACK || encounterType == Encounter.Police.ATTACK ||
                ...
                if (encounterAnim)
                    animateAttack(true, commanderGotHit, ship.hull <= 0); // NB Animation is a new addition
            }
            ...
            if (!commanderFlees) {
                ...
                if (encounterAnim)
                    animateAttack(false, opponentGotHit, opponent.hull <= 0); // NB Animation is a new addition
            }
            ...
            if (commanderFlees) {
                if (difficulty == DifficultyLevel.BEGINNER) {
                    ...
                    if (encounterAnim)
                        animateEnterExit(true, false); // NB Animation is a new addition
                ...
                if (getRandom(ship.skill(Skill.PILOT)) * 4 <=
                    ...
                    if (encounterAnim)
                        animateEnterExit(false, false); // NB Animation is a new addition
...
//			publishProgress();
    ...
    public void drawSpecialCargoForm() {
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.CARGO)
            return;
    ...
    public void drawQuestsForm() {
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.QUESTS)
            return;
    ...
    public void drawCurrentShipForm() {
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.SHIP)
            return;
    ...
    public void showShipYard() {
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.YARD)
            return;
...
//		screen.setViewTextById(R.id.screen_yard_buypod, R.string.screen_yard_havepod);
    ...
    public void drawPersonnelRoster() {
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.PERSONNEL)
            return;
...
//		screen.setViewTextById(R.id.screen_personnel_credits, R.string.format_cash, 202093);
    ...
    public void drawSystemInformationForm() {
        ...
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.INFO)
            return;
...
//		dialog.setCancelable(false);.
    ...
    public void drawEndGameScreen() {
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.ENDGAME)
            return;
    ...
    public void showExecuteWarp() {
        ...
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.TARGET)
            return;
...
//		page.findViewById(R.id.screen_warp_target_cost_specific).setVisibility(View.INVISIBLE);
    ...
    public void showAveragePrices() {
        ...
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.AVGPRICES)
            return;
...
//			showAveragePrices();
    ...
    public void drawShortRange(Canvas canvas) {
        ...
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.WARP)
            return;
...
//		d.draw(canvas);
    ...
    public void drawGalaxy(Canvas canvas) {
        BaseScreen screen = mGameManager.getCurrentScreen();
        if (screen == null || screen.getView() == null || screen.getType() != ScreenType.CHART)
            return;
